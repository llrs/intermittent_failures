...
```{r packages-dependencies, eval=length(unique(possible_packages$Package)) != 0}
...
```{r intermittent-failures, eval=length(unique(possible_packages$Package)) != 0}
...
```{r table-failures, eval=length(unique(possible_packages$Package)) != 0}
...
```{r results='asis', eval=length(unique(possible_packages$Package)) != 0}
